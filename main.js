...
System.register("projectile", ["actor", "damager", "point", "collider", "character", "wall", "game", "helpers", "rect"], function (exports_10, context_10) {
    ...
    var actor_1, damager_1, point_4, collider_2, character_1, wall_1, game_2, Helpers, rect_2, Projectile, BusterProj, Buster2Proj, Buster3Proj, TorpedoProj, StingProj, RollingShieldProj, FireWaveProj, TornadoProj, ElectricSparkProj, BoomerangProj, ShotgunIceProj;
    return {
        setters: [
            function (actor_1_1) {
                actor_1 = actor_1_1;
        ...
        execute: function () {
            Projectile = (function (_super) {
                ...
                Projectile.prototype.update = function () {
                    ...
                    for (var playerId in this.charToHitCooldown) {
                        this.charToHitCooldown[playerId] -= game_2.game.deltaTime;
                    ...
                    if (character instanceof character_1.Character && character.player.alliance !== this.damager.owner.alliance) {
                        ...
                        if (character_2 instanceof character_1.Character) {
                            if (this instanceof FireWaveProj) {
                                if (character_2.fireWaveHitCooldown > 0)
                                    return;
                                character_2.fireWaveHitCooldown = 0.2;
                            }
                            if (!this.charToHitCooldown[character_2.player.id]) {
                                this.charToHitCooldown[character_2.player.id] = this.hitCooldown;
            ...
            BoomerangProj = (function (_super) {
                ...
                BoomerangProj.prototype.onCollision = function (other) {
                    ...
                    var character = other.collider.gameObject;
                    if (character instanceof character_1.Character && character.player === this.damager.owner) {
                        this.destroySelf();
...
System.register("weapon", ["projectile", "game", "point", "helpers"], function (exports_11, context_11) {
    "use strict";
    var __moduleName = context_11 && context_11.id;
    var projectile_1, game_3, point_5, Helpers, Weapon, Buster, Torpedo, Sting, RollingShield, FireWave, Tornado, ElectricSpark, Boomerang, ShotgunIce;
    return {
        setters: [
...
System.register("character", ["actor", "game", "point", "collider", "rect", "helpers", "weapon", "effects", "ai"], function (exports_14, context_14) {
    ...
    var actor_2, game_6, point_8, collider_3, rect_3, Helpers, weapon_1, effects_1, ai_1, Character, CharState, Idle, Run, Jump, Fall, Dash, WallSlide, WallKick, Hurt, Die;
    return {
        setters: [
            function (actor_2_1) {
                actor_2 = actor_2_1;
            ...
            Character = (function (_super) {
                ...
                Character.prototype.update = function () {
                    if (this.fireWaveHitCooldown > 0) {
                        this.fireWaveHitCooldown = Helpers.clampMin(this.fireWaveHitCooldown - game_6.game.deltaTime, 0);
                    }
                    if (this.ai) {
                        this.ai.update();
                    }
...
System.register("level", ["wall", "point", "game", "helpers", "actor", "rect", "collider", "projectile"], function (exports_16, context_16) {
    ...
    var wall_2, point_9, game_8, Helpers, actor_3, rect_4, collider_4, projectile_3, Level;
    return {
        setters: [
            function (wall_2_1) {
                wall_2 = wall_2_1;
...
System.register("sprite", ["collider", "frame", "point", "rect", "game", "helpers"], function (exports_22, context_22) {
    ...
    var collider_5, frame_1, point_11, rect_5, game_9, Helpers, Sprite;
    return {
        setters: [
            ...
            Sprite = (function () {
                function Sprite(spriteJson) {
                    ...
                    for (var _b = 0, _c = spriteJson.frames; _b < _c.length; _b++) {
                        var frameJson = _c[_b];
                        var frame = new frame_1.Frame(new rect_5.Rect(frameJson.rect.topLeftPoint.x, frameJson.rect.topLeftPoint.y, frameJson.rect.botRightPoint.x, frameJson.rect.botRightPoint.y), frameJson.duration, new point_11.Point(frameJson.offset.x, frameJson.offset.y));
                        if (frameJson.POIs) {
