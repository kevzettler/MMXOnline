...
System.register("projectile", ["actor", "damager", "character", "game"], function (exports_9, context_9) {
    ...
    var actor_1, damager_1, character_1, game_2, Projectile, BusterProj, TorpedoProj;
    return {
        setters: [
            function (actor_1_1) {
                actor_1 = actor_1_1;
    ...
    return {
        ...
        execute: function () {
            Weapon = (function () {
                ...
                Weapon.prototype.getProjectile = function (pos, vel, player) {
                    return undefined;
                };
                Weapon.prototype.shoot = function (pos, vel, player) {
                    var proj = this.getProjectile(pos, vel, player);
                    game_3.game.playSound(this.shootSound);
            ...
            Buster = (function (_super) {
                ...
                function Buster() {
                    var _this = _super.call(this) || this;
                    _this.shootSound = "buster";
                    _this.index = 0;
                    return _this;
                }
                Buster.prototype.getProjectile = function (pos, vel, player) {
            ...
            Torpedo = (function (_super) {
                ...
                function Torpedo() {
                    var _this = _super.call(this) || this;
                    _this.shootSound = "torpedo";
                    _this.index = 1;
                    return _this;
                }
                Torpedo.prototype.getProjectile = function (pos, vel, player) {
