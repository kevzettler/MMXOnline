                ...
                function Level(levelJson) {
                    ...
                    for (var _i = 0, _a = levelJson.instances; _i < _a.length; _i++) {
                        ...
                        if (instance.className === "ShapeInstance") {
                            ...
                            this.gameObjects.push(new wall_1.Wall(points));
                        }
                        else {
...
System.register("collider", ["point", "shape"], function (exports_20, context_20) {
    "use strict";
    var __moduleName = context_20 && context_20.id;
    var point_10, shape_1, Collider, CollideData;
    return {
        setters: [
            function (point_10_1) {
                point_10 = point_10_1;
...
System.register("sprite", ["collider", "frame", "point", "rect", "game", "helpers"], function (exports_22, context_22) {
    ...
    var collider_4, frame_1, point_11, rect_4, game_9, Helpers, Sprite;
    return {
        setters: [
        ...
        execute: function () {
            Sprite = (function () {
                function Sprite(spriteJson) {
                    ...
                    for (var _i = 0, _a = spriteJson.hitboxes; _i < _a.length; _i++) {
                        ...
                        var hitbox = new collider_4.Collider([
                            new point_11.Point(hitboxJson.offset.x, hitboxJson.offset.y),
                    ...
                    for (var _b = 0, _c = spriteJson.frames; _b < _c.length; _b++) {
                        var frameJson = _c[_b];
                        var frame = new frame_1.Frame(new rect_4.Rect(frameJson.rect.topLeftPoint.x, frameJson.rect.topLeftPoint.y, frameJson.rect.botRightPoint.x, frameJson.rect.botRightPoint.y), frameJson.duration, new point_11.Point(frameJson.offset.x, frameJson.offset.y));
                        if (frameJson.POIs) {
                            for (var _d = 0, _e = frameJson.POIs; _d < _e.length; _d++) {
                                var poi = _e[_d];
                                frame.POIs.push(new point_11.Point(poi.x, poi.y));
                            }
                        }
                ...
                Sprite.prototype.getAlignOffsetHelper = function (rect, offset, flipX, flipY) {
                    ...
                    return new point_11.Point(x + offset.x * flipX, y + offset.y * flipY);
                };
...
System.register("actor", ["point", "game", "helpers"], function (exports_23, context_23) {
    ...
    var point_12, game_10, Helpers, Actor, Anim;
    return {
        setters: [
            function (point_12_1) {
                point_12 = point_12_1;
                    ...
                    get: function () {
                        if (this.sprite.hitboxes.length === 0) {
                            if (this.globalCollider) {
                                ...
                                var offset_1 = this.sprite.getAlignOffsetHelper(rect, new point_12.Point(0, 0), this.xDir, this.yDir);
